...
namespace SharpShell
{
    ...
    class Program
    {
        ...
        static void Usage()
        {
            Console.Write(@"-= SharpShell by DarkRay =-
SharpShell tcp listen 0.0.0.0 8080
SharpShell tcp connect 192.168.1.1 8080
SharpShell udp listen 0.0.0.0 8080
SharpShell udp connect 192.168.1.1 8080
SharpShell icmp connect 192.168.1.1
SharpShell dns direct 192.168.1.1 test.com
SharpShell dns recurse test.com
");
        }
